...
mocha_1.describe('Extract Abbreviations', () => {
    mocha_1.it('should extract abbreviations from document html', () => {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedRangeStartLine, expectedRangeStartChar, expectedRangeEndLine, expectedRangeEndChar, expectedFilter]) => {
            ...
            const result = emmetHelper_1.extractAbbreviation(document, position);
    ...
    mocha_1.it('should extract abbreviations from document css', () => {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedRangeStartLine, expectedRangeStartChar, expectedRangeEndLine, expectedRangeEndChar, expectedFilter]) => {
            ...
            const result = emmetHelper_1.extractAbbreviation(document, position, extractOptions);
            assert_1.default.ok(result);
            const { abbreviationRange, abbreviation, filter } = result;
            assert_1.default.strictEqual(expectedAbbr, abbreviation);
            assert_1.default.strictEqual(expectedRangeStartLine, abbreviationRange.start.line);
    ...
    mocha_1.it('should extract abbreviations from text', () => {
        ...
        testCases.forEach(([content, expectedAbbr, expectedFilter]) => {
            const result = emmetHelper_1.extractAbbreviationFromText(content, 'html');
            assert_1.default.ok(result);
...
mocha_1.describe('Test custom snippets', () => {
    ...
    mocha_1.it('should use custom snippets inherited from base syntax from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield updateExtensionsPath(extensionsPath);
        const expandOptionsWithCustomSnippets = emmetHelper_1.getExpandOptions('css');
        const expandOptionsWithCustomSnippetsInheritedSyntax = emmetHelper_1.getExpandOptions('scss');
        assert_1.default.ok(expandOptionsWithCustomSnippets.snippets);
    ...
    mocha_1.it('should do nothing when non-existent extensionsPath is given', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(extensionsPath);
        assert_1.default.strictEqual(Object.keys(emmetHelper_1.getExpandOptions('scss').snippets).some(key => key === customSnippetKey), true);
        try {
    ...
    mocha_1.it('should do nothing when directory with no snippets is given', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(extensionsPath);
    ...
    mocha_1.it('should use the first valid custom snippets from an array of extensions path', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath([]);
        const expandOptionsWithoutCustomSnippets = emmetHelper_1.getExpandOptions('css');
        assert_1.default(!expandOptionsWithoutCustomSnippets.snippets);
    ...
    mocha_1.it('should override earlier snippets with later snippets', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield updateExtensionsPath(extensionsPathArray);
            const expandOptions = emmetHelper_1.getExpandOptions('css');
    ...
    mocha_1.it('should do nothing when all extensionsPath in the array are invalid', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    mocha_1.it('should still suggest link:css snippet', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
...
mocha_1.describe('Test completions', () => {
    ...
    mocha_1.it('should not provide link:m as a suggestion', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    mocha_1.it('should not provide marginright as a suggestion SCSS', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    mocha_1.it('should provide completions for scss', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath([]);
        const testCases = [
            ['m:a', 0, 3]
        ];
    ...
    mocha_1.it('should provide completions for pascal-case tags when typing (jsx)', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath([]);
        const testCases = [
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedExpansion]) => {
            ...
            const position = vscode_languageserver_types_1.Position.create(positionLine, positionChar);
            const completionList = emmetHelper_1.doComplete(document, position, 'jsx', {
                preferences: {},
                showExpandedAbbreviation: 'always',
                showAbbreviationSuggestions: false,
                syntaxProfiles: {},
    ...
    mocha_1.it('should provide completions for lorem*2 with 2 lines', () => __awaiter(void 0, void 0, void 0, function* () {
