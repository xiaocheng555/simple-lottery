    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let emmetExtensionsPath of emmetExtensionsPathSetting) {
            ...
            if (emmetExtensionsPath.length && emmetExtensionsPath[0] === '~') {
                if (homeDir) {
                    emmetExtensionsPathUri.push(fileService_1.joinPath(homeDir, emmetExtensionsPath.substr(1)));
                }
            }
                ...
                if (workspaceFolderPaths) {
                    ...
                    for (const workspacePath of workspaceFolderPaths) {
                        emmetExtensionsPathUri.push(fileService_1.joinPath(workspacePath, emmetExtensionsPath));
                    }
                }
            }
            else {
        ...
        for (const uri of emmetExtensionsPathUri) {
            ...
            const snippetsPath = fileService_1.joinPath(uri, 'snippets.json');
            const profilesPath = fileService_1.joinPath(uri, 'syntaxProfiles.json');
