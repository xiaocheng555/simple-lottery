export declare const Button: import("../utils").WithInstall<import("vue").DefineComponent<{
    ...
    nativeType: {
        ...
        default: import("./Button").ButtonNativeType;
    };
    loadingSize: (NumberConstructor | StringConstructor)[];
    loadingText: StringConstructor;
    loadingType: import("vue").PropType<import("..").LoadingType>;
    iconPosition: {
        type: import("vue").PropType<import("./Button").ButtonIconPosition>;
        default: import("./Button").ButtonIconPosition;
    };
    ...
    iconPosition: import("./Button").ButtonIconPosition;
} & {
